            ...
            <TableBody>
              {cart.map((item) => (
                <TableRow key={item.id} className="border-b">
                  ...
                  <TableCell className="p-4 text-gray-700">${item.price.toFixed(2)}</TableCell>
                  <TableCell className="p-4">
                  ...
                  <TableCell className="p-4 text-gray-700">${(item.price * item.quantity).toFixed(2)}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
