...
function Hero() {
  return (
    <div className="bg-gray-800 mt-6 md:mt-10 flex flex-col md:flex-row items-center md:items-stretch justify-between text-white relative rounded-xl px-7 md:px-10 space-y-6 md:space-y-0">
